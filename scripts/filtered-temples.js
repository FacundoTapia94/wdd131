...
const temples = [
    ...
    // Add more temple objects here...
  {
    ...
    area: 27000,
    imageUrl:
    "https://churchofjesuschristtemples.org/assets/img/temples/salta-argentina-temple/salta-argentina-temple-48241-thumb.jpg"
  },
  
  {
    ...
    area: 9600,
    imageUrl:
    "https://churchofjesuschristtemples.org/assets/img/temples/lima-peru-temple/lima-peru-temple-12721-thumb.jpg"
  },
...
function createTempleCards(filteredTemples) {
  ...
  filteredTemples.forEach(temple => {
    ...
    img.setAttribute("atl", `${temple.templeName} Temple`);
